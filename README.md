...
- 논문: https://arxiv.org/abs/2011.03588
...
| ---------------------- | ------ | ------------------------- | ------------ | ------- | ---------------------- |
| **EXAONE 3.5 2.4B**    | 약 2.4B | 중상 (실 사용 경험 기반)           | 보통 (8bit 기준) | 중간      | 지식문 침적화, 경량 버전         |
| **skt/kogpt2-base-v2** | 약 125M | 중 (한국어 사전학습 기반)           | 빠름           | 낮음      | 한국어 GPT 계열, 생성형에 적합    |
| **tiny-ko-sft**        | 약 1.1B | 중상 (지시문 + 대화 fine-tuning) | 중간           | 낮음\~중간  | 한국어 인스트럭션 튜닝 모델, 대화 적합 |
